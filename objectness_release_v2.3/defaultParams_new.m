function params = defaultParams_new(dirRoot, cue_num)
...
%params.data = [dirRoot '\objectness_release_v2.3\Data\'];
...
params.pobj = 0.0797;
% params.tempdir = [dirRoot '\tmpdir\'];
params.pascalThreshold = 0.5;
if cue_num == 5
    params.cues = {'MS','CC','ED','LS','SS'};%full objectness measure
else
    params.cues = {'MS','CC','ED'};
end
...
%params for LS
params.LS.name = 'LS';
params.LS.referenceFrame = [100 100];
params.LS.kNN = 10;
params.LS.normalizedWindows = 0;
params.LS.ExemplarsMatFile = [dirRoot '/exemplarsNormalized_1183images.mat'];
params.LS.pobj = params.pobj;%